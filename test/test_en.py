...
class TestInflection(unittest.TestCase):
    ...
    def test_indefinite_article(self):
        ...
        self.assertEqual(
            en.inflect.article("heir", function=en.DEFINITE), "the")
        self.assertEqual(en.inflect.referenced("ewe"), "a ewe")
        print("pattern_text.en.inflect.article()")

    def test_pluralize(self):
        # Assert "octopodes" for classical plural of "octopus".
        # Assert "octopuses" for modern plural.
        self.assertEqual(
            "octopodes", en.inflect.pluralize("octopus", classical=True))
        self.assertEqual(
        ...
        print("pattern_text.en.inflect.pluralize()")
    ...
    def test_singularize(self):
        ...
        for sg, pl in Datasheet.load(os.path.join(PATH, "corpora", "wordforms-en-celex.csv")):
            ...
            n += 1
        self.assertTrue(float(i) / n > 0.95)
        print("pattern_text.en.inflect.singularize()")
    ...
    def test_find_lemma(self):
        ...
        print("pattern_text.inflect.verbs.find_lemma()")
    ...
    def test_find_lexeme(self):
        ...
        for v, lexeme1 in en.inflect.verbs.infinitives.items():
            ...
            for j in range(len(lexeme2)):
                ...
                n += 1
        self.assertTrue(float(i) / n > 0.90)
        print("pattern_text.inflect.verbs.find_lexeme()")
    ...
    def test_lexeme(self):
        ...
        print("pattern_text.inflect.lexeme()")

    def test_tenses(self):
        # Assert tense recognition.
        self.assertTrue(
            (en.inflect.PRESENT, 1, en.inflect.SINGULAR) in en.inflect.tenses("am"))
        ...
        print("pattern_text.inflect.tenses()")

    def test_comparative(self):
        # Assert "nice" => "nicer".
        self.assertEqual(en.inflect.comparative("nice"), "nicer")
        print("pattern_text.inflect.comparative()")
    ...
    def test_superlative(self):
        ...
        print("pattern_text.inflect.superlative()")
...
class TestQuantification(unittest.TestCase):
    ...
    def test_extract_leading_zeros(self):
        ...
        from pattern_text.en.inflect_quantify import zshift
        v = zshift("zero zero one")
        self.assertEqual(v, ("one", 2))
        v = zshift("0 0 one")
        self.assertEqual(v, ("one", 2))
        print("pattern_text.quantify._extract_leading_zeros()")
...
class TestParser(unittest.TestCase):
    ...
    def test_default_suffix_rules(self):
        ...
        for a, b in (
            ...
            self.assertEqual(pattern_text._suffix_rules(a), b)
    ...
    def test_apply_morphological_rules(self):
        ...
        print("pattern_text.parser.morphology.apply()")
    ...
    def test_apply_context_rules(self):
        ...
        print("pattern_text.parser.context.apply()")
    ...
    def test_find_chunks(self):
        ...
        self.assertEqual(
            v, [["black", "JJ", "B-NP", "O"], ["cat", "NN", "I-NP", "O"]])
        ...
        self.assertEqual(
            v, [["", "RB", "B-ADVP", "O"], ["", "PRP", "B-NP", "O"]])
        # - "very nice cats" (NP)
        v = en.parser.find_chunks([["", "RB"], ["", "JJ"], ["", "PRP"]])
        self.assertEqual(
            v, [["", "RB", "B-NP", "O"], ["", "JJ", "I-NP", "O"], ["", "PRP", "I-NP", "O"]])
    ...
    def test_find_labels(self):
        ...
        self.assertEqual(v, [
            ...
            ["", "", "VP", "VP-1"], ["", "", "VP", "VP-1"],
            ["", "", "NP", "NP-OBJ-1"]])
        print("pattern_text.parser.find_labels()")
    ...
    def test_find_prepositions(self):
        ...
        v = en.parse(
            "The cat was looking at me from up on the roof with interest.", prepositions=True)
        self.assertEqual(v,
        ...
        print("pattern_text.parser.find_prepositions()")

    def test_find_lemmata(self):
        # Assert lemmata for nouns and verbs.
        v = en.parser.find_lemmata(
            [["cats", "NNS"], ["wearing", "VBG"], ["hats", "NNS"]])
        self.assertEqual(v, [
            ["cats", "NNS", "cat"],
            ["wearing", "VBG", "wear"],
            ["hats", "NNS", "hat"]])
        print("pattern_text.parser.find_lemmata()")
    ...
    def test_named_entity_recognition(self):
        ...
        print("pattern_text.parser.entities.apply()")

    def test_parse(self):
        # Assert parsed output with Penn Treebank II tags (slash-formatted).
        # 1) "the black cat" is a noun phrase, "on the mat" is a prepositional
        # noun phrase.
        ...
        # 5) Assert unicode for faulty input (bytestring with unicode
        # characters).
        self.assertTrue(isinstance(en.parse("ø ü"), unicode))
        self.assertTrue(
            isinstance(en.parse("ø ü", tokenize=True,  tags=False, chunks=False), unicode))
        self.assertTrue(
            isinstance(en.parse("ø ü", tokenize=False, tags=False, chunks=False), unicode))
        self.assertTrue(isinstance(en.parse("o u", encoding="ascii"), unicode))
        # 6) Assert optional parameters (i.e., setting all to False).
        self.assertEqual(
            en.parse("ø ü.", tokenize=True,  tags=False, chunks=False), u"ø ü .")
        self.assertEqual(
            en.parse("ø ü.", tokenize=False, tags=False, chunks=False), u"ø ü.")
    ...
    def test_ngrams(self):
        ...
        self.assertEqual(
            v1, [("The", "cat"), ("cat", "is"), ("is", "napping")])
        self.assertEqual(
            v2, [("The", "cat", "is"), ("cat", "is", "napping"), ("is", "napping", ".")])
        s = "The cat purrs. The dog barks."
        v1 = en.ngrams(s, n=2)
        v2 = en.ngrams(s, n=2, continuous=True)
        self.assertEqual(
            v1, [("The", "cat"), ("cat", "purrs"), ("The", "dog"), ("dog", "barks")])
        self.assertEqual(v2, [("The", "cat"), ("cat", "purrs"),
                              ("purrs", "The"), ("The", "dog"), ("dog", "barks")])
    ...
    def test_command_line(self):
        ...
        # documentation).
        command = ["python", "-m", "pattern_text", "-s", "Nice cat.", "-OTCRL"]
...
class TestParseTree(unittest.TestCase):
    ...
    def test_copy(self):
        ...
        print("pattern_text.Text.copy()")

    def test_xml(self):
        # Assert XML export and import.
        self.text = en.Text.from_xml(self.text.xml)
        print("pattern_text.Text.xml")
        print("pattern_text.Text.from_xml()")

    def test_text(self):
        # Assert Text.
        self.assertEqual(
            self.text.sentences[0].string, "I 'm eating pizza with a fork .")
        self.assertEqual(self.text.sentences[1].string, "What a tasty pizza !")
        print("pattern_text.Text")
    ...
    def test_sentence_constituents(self):
        ...
        print("pattern_text.Sentence.constituents()")
    ...
    def test_chunk(self):
        ...
        self.assertTrue(
            v.words == [self.text[0].words[5], self.text[0].words[6]])
        ...
        self.assertTrue(
            v.related == [self.text[0].chunks[0], self.text[0].chunks[1]])
    ...
    def test_chunk_modifiers(self):
        ...
        print("pattern_text.Chunk.modifiers")
    ...
    def test_pnp(self):
        ...
        self.assertTrue(
            v.chunks == [self.text[0].chunks[3], self.text[0].chunks[4]])
        self.assertTrue(v.pp == self.text[0].chunks[3])
        print("pattern_text.PNP")
    ...
    def test_word_custom_tags(self):
        ...
        print("pattern_text.Word.custom_tags")

    def test_find(self):
        # Assert first item for which given function is True.
        v = pattern_text.tree.find(lambda x: x > 10, [1, 2, 3, 11, 12])
        self.assertEqual(v, 11)
        print("pattern_text.tree.find()")

    def test_unzip(self):
        v = pattern_text.tree.unzip(1, [(1, 4), (2, 5), (3, 6)])
        self.assertEqual(v, [4, 5, 6])
        print("pattern_text.tree.unzip()")

    def test_unique(self):
        # Assert list copy with unique items.
        v = pattern_text.tree.unique([1, 1, 1])
        self.assertEqual(len(v), 1)
        self.assertEqual(v[0], 1)
        print("pattern_text.tree.unique()")

    def test_map(self):
        # Assert dynamic Map().
        v = pattern_text.tree.Map(lambda x: x + 1, [1, 2, 3])
        self.assertEqual(list(v), [2, 3, 4])
        self.assertEqual(v.items[0], 1)
        print("pattern_text.tree.Map()")
...
class TestModality(unittest.TestCase):
    ...
    def test_imperative(self):
        ...
        from pattern_text.en.modality import imperative
        for b, s in (
        ...
        print("pattern_text.modality.imperative()")

    def test_conditional(self):
        # Assert True for sentences that contain possible or imaginary
        # situations.
        from pattern_text.en.modality import conditional
        for b, s in (
    ...
    def test_subjunctive(self):
        ...
        print("pattern_text.modality.subjunctive()")
...
class TestSentiment(unittest.TestCase):
    ...
    def test_sentiment_avg(self):
        ...
        if True:
            raise unittest.SkipTest("FIXME")
        from pattern_text import avg
        v = avg([1, 2, 3, 4])
        self.assertEqual(v, 2.5)
        print("pattern_text.avg")
    ...
    def test_subjectivity(self):
        ...
        print("pattern_text.subjectivity()")
    ...
    def test_sentiwordnet(self):
        ...
        try:
            from pattern_text.en.wordnet import SentiWordNet
            lexicon = SentiWordNet()
            lexicon.load()
        except ImportError as e:
            # SentiWordNet data file is not installed in default location, stop
            # test.
            print(e)
            return
        self.assertTrue(lexicon["wonderful"][0] > 0)
        self.assertTrue(lexicon["horrible"][0] < 0)
        print("pattern_text.sentiment.SentiWordNet")
...
class TestWordNet(unittest.TestCase):
    ...
    def test_synsets(self):
        ...
        # Assert TypeError when part-of-speech is not NOUN, VERB, ADJECTIVE or
        # ADVERB.
        self.assertRaises(TypeError, en.wordnet.synsets, "cat", "unknown_pos")
        print("pattern_text.wordnet.synsets()")
    ...
    def test_synset(self):
        ...
        print("pattern_text.wordnet.Synset")
    ...
    def test_ancenstor(self):
        ...
        self.assertTrue(
            en.wordnet.ancestor(v1, v2) == en.wordnet.synsets("carnivore")[0])
        print("pattern_text.wordnet.ancestor()")
    ...
    def test_map32(self):
        ...
        print("pattern_text.wordnet.map32")
    ...
    def test_sentiwordnet(self):
        ...
        print("pattern_text.wordnet.sentiwordnet")
...
class TestWordlists(unittest.TestCase):
    ...
    def test_wordlist(self):
        ...
        print("pattern_text.wordlist.Wordlist")
